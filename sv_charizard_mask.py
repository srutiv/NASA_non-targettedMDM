...
#    old_gray = old_gray[]
    ...
    [refPt, masked_gray, boundbox] = big(list_names[0])
    ...
    feature_params = dict(maxCorners = 100,
                           ...
                           blockSize = 7,
                           gradientSize = 7,
                           mask = masked_gray) #ROI from trials
    ...
    while index < (len(list_names)-1):
        ...
        img = cv2.add(img,boundbox) #plot ROIs and OG image; boundbox from trials
