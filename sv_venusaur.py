...
def SIFT_detectTrack(first_cam, second_cam, tag = True):
    disp3 = []
    first = 0
...
first_cam = ['C:/Users/svutukur/Documents/tbw3_sample_data/run001/seq007/A_run001_seq007_00' + str(i) + '.tiff' for i in range(10,16)]
second_cam = ['C:/Users/svutukur/Documents/tbw3_sample_data/run001/seq007/B_run001_seq007_00' + str(i) + '.tiff' for i in range(10,16)]

print('number of MDM images to track: ' + str(len(list_names)))

num_roi = 2

[tot_disps, disps_roi] = SIFT_detectTrack(first_cam, second_cam, tag = True)
